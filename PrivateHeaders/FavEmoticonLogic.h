...
@interface FavEmoticonLogic : NSObject <GetEmotionFavMD5ListCGIDelegate, EmoticonUploadCGIDelegate, EmoticonOperateCGIDelegate, ExchangeEmoticonPackCgiDelegate>
{
    id <FavEmoticonLogicDelegate> _delegate;
...
@property(nonatomic) __weak id <FavEmoticonLogicDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
...
- (void)removeFavEmoticonLocalCahceWithMD5:(id)arg1;
