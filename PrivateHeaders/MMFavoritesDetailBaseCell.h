...
@class CALayer, FavoritesItem, MMView, NSImageView, NSString, WCContactData;
...
@property(retain, nonatomic) MMView *favContentView; // @synthesize favContentView=_favContentView;
