...
+ (_Bool)decodeObject:(id)arg1 fromData:(id)arg2 withProperty:(id)arg3 andTagIndexMap:(const map_d2afedfd *)arg4;
+ (_Bool)encodeObject:(id)arg1 withPropertyTable:(id)arg2 toFile:(id)arg3;
+ (id)encodeObject:(id)arg1 withPropertyTable:(id)arg2;
- (void).cxx_destruct;
- (id)decodeOneObject:(id)arg1 withProperty:(id)arg2 andTagIndexMap:(const map_d2afedfd *)arg3;
- (id)decodeOneObject:(id)arg1 ofClass:(Class)arg2;
- (void)decodeObject:(id)arg1 withProperty:(id)arg2 andTagIndexMap:(const map_d2afedfd *)arg3;
