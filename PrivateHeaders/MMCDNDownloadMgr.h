...
- (id)fileCDNDownloadParaWithFavItemData:(id)arg1 isVideo:(BOOL)arg2 downloadPriority:(int)arg3;
...
- (id)downloadCDNFileWithFavItemData:(id)arg1 type:(int)arg2 downloadPriority:(int)arg3;
...
- (void)downloadImageWithMessage:(id)arg1;
