...
@class FavoritesItem, MMBorderView, MMCTTextView, MMView, MessageData, NSImageView, NSMutableArray, NSTextField;

@interface MMAppNoteMessageCellView : MMMessageCellView
{
