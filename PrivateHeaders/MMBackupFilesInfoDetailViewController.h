...
@interface MMBackupFilesInfoDetailViewController : MMViewController <NSTableViewDelegate, NSTableViewDataSource, MMTableViewDelegate, MMBackupFileInfoCellViewDelegate>
{
    ...
    NSTextField *_operationColumnTextField;
...
@property(retain, nonatomic) NSTextField *operationColumnTextField; // @synthesize operationColumnTextField=_operationColumnTextField;
