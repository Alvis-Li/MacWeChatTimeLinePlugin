...
@interface FavoritesUploadMgr : MMObject <FavoritesUploaderDelegate>
{
    ...
    BOOL _isCountingMd5;
    NSObject<OS_dispatch_queue> *queue_countMd5;
...
- (BOOL)deleteCdnInfoByFavoritesItemLocalId:(unsigned int)arg1;
