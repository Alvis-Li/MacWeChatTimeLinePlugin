...
@interface MMEmoticonCaptionRow : NSObject <WCDBCoding>
{
    NSString *md5;
    NSString *caption;
    NSString *language;
...
+ (void)_initPBTableOfMMEmoticonCaptionRow;
+ (id)dummyObject;
...
- (id)getValueTable;
- (const WCDBCondition_0fe98630 *)db_language;
- (const WCDBCondition_0fe98630 *)db_caption;
