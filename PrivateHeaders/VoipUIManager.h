...
@interface VoipUIManager : MMService <IMessageExt, AccountServiceExt, MMVoipBaseWindowControllerDelegate, MMService, MMConfigMgrExt, CNUserNotificationCenterDelegate>
{
    BOOL m_isCaller;
    BOOL _isLockScrren;
...
@property(nonatomic) BOOL isLockScrren; // @synthesize isLockScrren=_isLockScrren;
...
- (void)onGetVoipNotifyWithData:(id)arg1;
