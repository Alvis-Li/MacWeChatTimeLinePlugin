...
@interface MMSessionPickerWindow : NSWindowController <AccountServiceExt, WeChatSearchProtocol>
{
...
+ (id)shareInstanceToNewChat;
+ (id)shareInstanceToForward;
...
- (void)setAssignedUserNames:(id)arg1;
...
- (void)windowDidLoad;
- (void)dealloc;
- (id)initWithType:(unsigned long long)arg1 sessionPickerUserNames:(id)arg2;
- (id)init;
