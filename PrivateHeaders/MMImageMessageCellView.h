...
@interface MMImageMessageCellView : MMMessageCellView <MMCDNDownloadMgrExt, NSPasteboardItemDataProvider>
{
    struct CGRect _imgDrawRect;
    long long _resizeCountInDrawRect;
    BOOL _isStartDownloadManully;
    BOOL _isOriginalImageDownloaded;
...
@property(nonatomic) BOOL isOriginalImageDownloaded; // @synthesize isOriginalImageDownloaded=_isOriginalImageDownloaded;
