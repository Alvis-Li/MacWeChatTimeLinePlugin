...
@class MMLockViewController, MMLoginDidScannedQRCodeViewController, MMLoginIntroViewController, MMLoginOneClickViewController, MMLoginQRCodeViewController, MMLoginStateMachine, MMLoginWaitingConfirmViewController, MMNavigationController, NSString, QRCodeLoginLogic;
